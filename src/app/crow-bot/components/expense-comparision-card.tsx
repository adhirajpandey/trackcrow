...
export const ExpenseComparisonCard = ({
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto rounded-xl border border-border px-8 py-6 shadow-md flex flex-col space-y-4 bg-background/40 transition-all">
      {/* Header */}
