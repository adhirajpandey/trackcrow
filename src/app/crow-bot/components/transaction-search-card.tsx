...
export const TransactionSearchCard = ({
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto rounded-xl border border-border px-8 py-5 shadow-md flex flex-col space-y-4 bg-background/40">
      <div className="flex items-center justify-between border-b border-border pb-3">
        <div className="flex items-center gap-2 text-gray-200">
          <Search className="w-5 h-5 text-purple-400" />
          <h2 className="text-base font-medium">Transaction Search</h2>
        </div>
        <button
