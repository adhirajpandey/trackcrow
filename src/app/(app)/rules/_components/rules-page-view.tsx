    ...
    try {
      ...
      toast({
        ...
        description: initialRule
          ...
          : actionType === "IGNORE"
            ? "Matching future imports will not create transactions."
